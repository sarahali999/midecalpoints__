...
class Languages extends Translations {
  ...
  Map<String, Map<String, String>> get keys => {
    'ar': {
      ...
      'confirm': 'تأكيد',
      'about_app.title': 'الشروط والخدمة',
      'about_app.welcome_message': 'مرحبًا بك في تطبيقنا الطبي الخدمي!',
      'about_app.description': 'يهدف تطبيقنا إلى توفير خدمات طبية متكاملة للزوار الوافدين من داخل وخارج العراق لزيارة مقام الإمام الحسين وأخيه العباس عليهما السلام.',
      'about_app.services_title': 'خدماتنا الطبية',
      'about_app.services.emergency_care': 'رعاية طبية طارئة داخل الموقع',
      'about_app.services.medical_consultation': 'استشارات طبية مع أطباء مختصين',
